  ...
  <div class="zfile-index-setting-drawer">
    ...
    >
      <div class="zfile-index-setting-drawer-body">
        <div v-if="isMobile" class="zfile-index-setting-drawer-group">
        ...
        <div class="zfile-index-setting-drawer-group">
          ...
          <div class="zfile-index-setting-drawer-blockCheckbox">
            <el-tooltip effect="dark" content="列表模式" placement="bottom">
          ...
          <div class="px-2.5">
            <el-slider
              v-model="zfileSettingCache.view.size"
              size="large"
              :show-tooltip="false"
              :marks="marks"
              :step="1"
        ...
        <div class="zfile-index-setting-drawer-group">
          ...
          <div class="text-gray-400 text-sm">
            如已处于画廊模式，需重新启用画廊模式生效.
          </div>
          <div class="flex justify-between">
            <div class="text-lg font-medium">图片列数</div>
            <el-input-number
              v-model="zfileSettingCache.gallery.column"
              :min="1"
            ></el-input-number>
          </div>
          <div class="flex justify-between">
            ...
            <el-input-number
              v-model="zfileSettingCache.gallery.columnSpacing"
              :min="0"
            ></el-input-number>
          </div>
          <div class="flex justify-between">
            ...
            <el-input-number
              v-model="zfileSettingCache.gallery.rowSpacing"
              :min="0"
            ></el-input-number>
          </div>
          <div class="flex justify-between">
            ...
            <el-switch
              v-model="zfileSettingCache.gallery.roundedBorder"
            ></el-switch>
          </div>
          <div class="flex justify-between">
          ...
          <div class="flex justify-between">
            ...
            <el-select
              v-model="zfileSettingCache.gallery.showInfoMode"
              class="w-[150px]"
            >
          ...
          <div class="flex justify-between">
            ...
            <el-select
              v-model="zfileSettingCache.imagePreview.mode"
              class="w-[150px]"
            >
          ...
          <div class="flex justify-between">
            ...
            <el-switch
              v-model="zfileSettingCache.imagePreview.gallery"
            ></el-switch>
          </div>
          <div class="flex justify-between">
            <div class="text-lg font-medium">回到顶部按钮</div>
            <el-switch
              v-model="zfileSettingCache.gallery.showBackTop"
            ></el-switch>
          </div>
        </div>
