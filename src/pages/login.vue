  ...
  >
    ...
    >
      <div class="flex-1 bg-gray-50 text-center hidden lg:flex rounded-l-xl">
        <div
          class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat zfile-login-logo"
        />
      </div>
      <div class="w-full lg:w-1/2 xl:w-1/2 mt-10 p-6 sm:p-12">
        <div class="mt-0 flex flex-col items-center">
          <h1
            class="text-2xl mt-0 xl:text-3xl font-extrabold box animate__animated animate__fadeInDown"
          >
            <img
          ...
          <div class="w-full flex-1">
            <div class="my-12 relative">
              ...
              <div class="relative flex justify-center text-sm">
                <span
                  class="px-2 bg-white text-sm leading-none text-gray-600 tracking-wide font-medium"
                  >管理员登录</span
                >
              </div>
            </div>
            ...
            >
              ...
              >
                <el-tooltip class="item" effect="dark" placement="left">
                  <template #content>
                    将配置文件 application.properties 中 zfile.debug 修改为
                    true, 重启后访问首页即可重置密码 <br />
                    <a
                      target="_blank"
                      class="text-blue-400"
                      href="https://docs.zfile.vip/question#reset-pwd"
                      >点击可前往文档查看操作方式</a
                    >
                  </template>
                  <el-link
