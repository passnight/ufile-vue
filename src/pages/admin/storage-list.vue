        ...
        <div class="my-2 text-sm text-gray-500 flex justify-between flex-wrap">
          <div>
            ...
            <a
              class="link"
              target="_blank"
              href="https://docs.zfile.vip/example"
              >ZFile 存储源配置文档</a
            >
          </div>
          <div>
      ...
      >
        ...
        >
          <div class="flex-1 flex flex-col p-8 pb-4 relative">
            <svg-icon
              name="target"
              class="absolute left-3 top-3 text-sm cursor-pointer text-blue-500 opacity-0 group-hover:opacity-100"
            ...
            <div class="rounded-full bg-blue-50 w-fit mx-auto">
              <img
                class="w-20 h-20 flex-shrink-0 mx-auto p-4"
          ...
          <div class="-mt-px border-t flex divide-x divide-gray-200">
            ...
            >
              <span
                class="hover:text-blue-500 relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-2 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500 ml-3"
              >
                <el-icon class="mr-2">
                  <Edit />
                </el-icon>
