<template>
  <Disclosure v-slot="{ open }" as="nav" class="bg-white shadow">
    <div class="max-w-7xl mx-auto px-4 xl:px-0">
      <div class="relative flex justify-between h-16">
        ...
        >
          ...
          >
            <div
              v-if="githubLatestInfo?.data"
              class="zfile-admin-index-version-info text-center"
            >
              <div v-html="`当前版本：v${common.version}`"></div>
              <div v-html="`最新版：v${githubLatestInfo.data.tag_name}`"></div>
              <div
                v-html="
                  `发布时间: ${common.dateFormat(
                    githubLatestInfo.data.published_at
                  )}`
                "
              ></div>
              <br />
            ...
            <template #reference>
              ...
              >
                ...
                <img
                  ...
                  src="../assets/icons/zfile-horizontal.svg"
                  alt="Workflow"
                />
                <el-badge
                  :is-dot="
                    githubLatestInfo?.data?.tag_name &&
                    common.version !== githubLatestInfo?.data?.tag_name
                  "
                  class="hidden lg:block text-sm font-bold word ml-1 tracking-wider"
                >
                  {{ common.version }}
                </el-badge>
              </div>
          ...
          <div
            class="hidden lg:ml-6 md:flex md:space-x-4 justify-center flex-1 lg:flex-none"
          >
            <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
            <router-link
              to="/admin/site-setting"
              :class="
                currentActive === '/admin/site-setting'
            ...
            <router-link
              to="/admin/storage-list"
              :class="
                currentActive.startsWith('/admin/storage')
                  ? 'border-indigo-500 text-gray-900'
                  : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
              "
              class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
            ...
            <router-link
              ...
              :class="
                currentActive === '/admin/view-setting'
                  ? 'border-indigo-500 text-gray-900'
                  : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
              "
              class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
            ...
            <el-dropdown>
              <router-link
                to="/admin/download-link"
                :class="
                  currentActive.includes('/admin/download-link')
                    ? 'border-indigo-500 text-gray-900'
                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                "
                class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item :icon="Tickets">
                    <router-link to="/admin/download-link/log"
                      >直链日志</router-link
                    >
                  </el-dropdown-item>
                  <el-dropdown-item :icon="Setting">
                    <router-link to="/admin/download-link/setting"
                      >直链设置</router-link
                    >
                  </el-dropdown-item>
                </el-dropdown-menu>
            ...
            >
              ...
              >
                <div class="cursor-pointer border-b">
                  <MenuItem
                    v-slot="{ active }"
                    @click="common.openPage('https://docs.zfile.vip')"
                  >
                    <div
                      :class="[
                        active ? 'bg-gray-100' : '',
                  ...
                  <MenuItem
                    v-slot="{ active }"
                    @click="
                      common.openPage('https://github.com/zhaojun1998/zfile')
                    "
                  >
                    <div
                      :class="[
    ...
    <DisclosurePanel class="md:hidden">
      <div class="pt-2 pb-4 space-y-1">
        ...
        <DisclosureButton
          :class="
            currentActive === '/admin/download-link'
              ? 'bg-indigo-50 border-indigo-500 text-indigo-700'
              : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'
          "
          as="a"
        ...
        <DisclosureButton
          :class="
            currentActive === '/admin/download-link/log'
              ? 'bg-indigo-50 border-indigo-500 text-indigo-700'
              : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'
          "
          as="a"
        ...
        <DisclosureButton
          :class="
            currentActive === '/admin/download-link/setting'
              ? 'bg-indigo-50 border-indigo-500 text-indigo-700'
              : 'border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700'
          "
          as="a"
  ...
  <div
    class="p-0 sm:p-10 pb-16 sm:pb-26 bg-gray-100 h-full overflow-y-auto border-t-2"
  >
    <div
      class="max-w-7xl mx-auto bg-white shadow overflow-hidden sm:rounded-lg"
    >
